...
//             {/* Main Menu Links Generated via Array Map */}
...
//                 >
//                   {item.icon(darkTheme.colors.textMuted)}
//                   <Text
//                     style={[darkTheme.typography.bodyMain, styles.menuItemText]}
//                   >
//                     {item.title}
//                   </Text>
//                 </TouchableOpacity>
        ...
        <View style={styles.fullscreenContainer}>
          ...
          >
            ...
            <View style={styles.menuItemsList}>
              ...
              {/* Expandable Payments Parent Item */}
              <TouchableOpacity
