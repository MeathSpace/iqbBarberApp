...
const index = () => {
  const baseContent = i18n.t("app.barber.barbertabs.appointment");
      ...
      {selectedTab === "History" && (
        ...
        >
          <FlatList
            ...
            keyExtractor={(item) => item.id.toString()}
            renderItem={({ item }) => (
              <AppointmentHistoryCard item={item} colors={colors} />
            )}
            contentContainerStyle={{ gap: verticalScale(10) }}
            showsVerticalScrollIndicator={false}
          />
      ...
      >
        ...
        >
          ...
          <ThemeTextPrimary style={[styles.actionText, { color: "#eab308" }]}>
            {baseContent.appointmentCard.notify}
          </ThemeTextPrimary>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.actionBtn}
        ...
        >
          ...
          <ThemeTextPrimary style={[styles.actionText, { color: "#3b82f6" }]}>
            {baseContent.appointmentCard.msg}
          </ThemeTextPrimary>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.actionBtn}
        ...
        >
          ...
          <ThemeTextPrimary style={[styles.actionText, { color: "#22c55e" }]}>
            {baseContent.appointmentCard.serve}
          </ThemeTextPrimary>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.actionBtn}
        ...
        >
          ...
          <ThemeTextPrimary style={[styles.actionText, { color: "#ef4444" }]}>
            {baseContent.appointmentCard.cancel}l
          </ThemeTextPrimary>
        </TouchableOpacity>
      </Animated.View>
    </View>
    ...
    >
      <TouchableOpacity style={styles.header} activeOpacity={0.8}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <ThemeTextPrimary style={styles.price}>{item.price}</ThemeTextPrimary>
        </View>
        <TouchableOpacity
          activeOpacity={0.8}
          style={{
        ...
        >
          <ThemeTextPrimary style={{ fontSize: scale(14), color: "#dc2626" }}>
            cancelled
          </ThemeTextPrimary>
        </TouchableOpacity>
      </TouchableOpacity>
