...
const index = () => {
  const baseContent = i18n.t("app.barber.barbertabs.salon");
              ...
              {selectedTab === "Details" && (
                <>
                  ...
                  >
                    ...
                    >
                      {
                        "From classic cuts to modern styling, our skilled professionals are here to provide high-quality hair, skin, and grooming services in a clean, relaxing environment."
                      }
                    </ThemeTextSecondary>
                  </View>
                    ...
                    >
                      {true && (
                        <TouchableOpacity
                          ...
                          onPress={() => {
                            Linking.openURL(`tel:${91}${1234567890}`);
                          }}
                        >
                    ...
                    >
                      <View>
                        ...
                        >
                          ...
                          Connaught Place, Block A, Inner Circle, New Delhi,
                          India
                        </ThemeTextSecondary>
                      </View>
