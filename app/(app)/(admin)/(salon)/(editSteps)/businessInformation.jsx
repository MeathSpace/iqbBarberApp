...
const BusinessInformation = () => {
  ...
  const { editSalonBusinessInfo, setEditSalonBusinessInfo } = useAdminGlobal();
  ...
  const currentLat =
    parseFloat(editSalonBusinessInfo?.salonCoordinates?.lattitude) ||
    DEFAULT_COORDINATES.lattitude;
  const currentLng =
    parseFloat(editSalonBusinessInfo?.salonCoordinates?.longitude) ||
  ...
  const handleNextStep = () => {
    if (!editSalonBusinessInfo?.salonBusinessType?.trim()) {
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              <Dropdown
                ...
                value={editSalonBusinessInfo?.salonBusinessType || ""}
