...
const SelectServices = () => {
  ...
  const { editServiceForm, setEditServiceForm, editServicesList, setEditServicesList } =
    useAdminGlobal();
  ...
  useEffect(() => {
    ...
    if (!editServiceForm.serviceType) {
      setEditServiceForm((prev) => ({ ...prev, serviceType: "Regular" }));
    }
  ...
  const updateFormField = (key, value) => {
    ...
    setEditServiceForm((prev) => ({ ...prev, [key]: value }));
  };
  ...
  const validateForm = () => {
    ...
    if (!editServiceForm.serviceIcon?.trim()) {
      errors.serviceIcon = "Please select a service icon";
      isValid = false;
    }
    if (!editServiceForm.serviceName?.trim()) {
      errors.serviceName = "Service name is required";
      isValid = false;
    }
    if (!editServiceForm.serviceDescription?.trim()) {
      errors.serviceDescription = "Service description is required";
      isValid = false;
    }

    if (!editServiceForm.serviceCategory?.trim()) {
      errors.serviceCategory = "Service category is required";
      isValid = false;
    }
    if (!editServiceForm.servicePrice || Number(editServiceForm.servicePrice) <= 0) {
      errors.servicePrice = "Valid service price is required";
      isValid = false;
    }
    if (
      !editServiceForm.serviceEstimatedTime ||
      Number(editServiceForm.serviceEstimatedTime) <= 0
    ) {
  ...
  const handleAddService = () => {
    ...
    const isVipSelected = editServiceForm.serviceType === "VIP";

    const newService = {
      _id: String(Date.now()),
      serviceId: Date.now(),
      serviceIcon: editServiceForm.serviceIcon,
      serviceName: editServiceForm.serviceName.trim(),
      serviceDesc: editServiceForm.serviceDescription?.trim() || "",
      serviceDescription: editServiceForm.serviceDescription?.trim() || "",
      serviceCategoryName: editServiceForm.serviceCategory || "General",
      serviceCategory: editServiceForm.serviceCategory || "General",
      serviceType: editServiceForm.serviceType || "Regular",
      vipService: isVipSelected,
      servicePrice: Number(editServiceForm.servicePrice) || 0,
      serviceEWT: Number(editServiceForm.serviceEstimatedTime) || 0,
      serviceEstimatedTime: String(editServiceForm.serviceEstimatedTime),
      isDeleted: false,
    };

    setEditServicesList((prev) => ({
      ...prev,
    ...
    >
      ...
      >
        ...
        >
          ...
          <View style={styles.formContainerDeck}>
              ...
              {loading ? (
                ...
                >
                  {(iconsList || []).map((iconObj) => {
                    ...
                    const isSelected = editServiceForm.serviceIcon === iconUri;
                    return (
                      <TouchableOpacity
            ...
            <View style={styles.inputLayoutContainerGroup}>
              ...
              <TextInput
                ...
                value={editServiceForm.serviceDescription}
                onChangeText={(text) =>
            ...
            <View style={styles.inputLayoutContainerGroup}>
              ...
              <Dropdown
                ...
                value={editServiceForm.serviceCategory}
            ...
            <View style={styles.inputLayoutContainerGroup}>
              ...
              <Dropdown
                ...
                value={editServiceForm.serviceType || "Regular"}
            ...
            <View style={styles.inputLayoutContainerGroup}>
              ...
              <TextInput
                ...
                value={editServiceForm.servicePrice}
                onChangeText={(text) => {
                  const cleanedText = text.replace(/[^0-9]/g, "");
            ...
            <View style={styles.inputLayoutContainerGroup}>
              ...
              <TextInput
                ...
                value={editServiceForm.serviceEstimatedTime}
                onChangeText={(text) => {
                  const cleanedText = text.replace(/[^0-9]/g, "");
            ...
            <View style={styles.dualFormActionRowTriggerSection}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                onPress={() => {
                  if (editServicesList?.data?.length === 0) {
                    Alert.alert(
                      "Services Required",
          ...
          {(editServicesList?.data || []).map((item) => (
            <ServiceCardItem
