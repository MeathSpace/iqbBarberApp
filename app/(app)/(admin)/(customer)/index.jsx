...
const CustomerListScreen = () => {
  ...
  return (
    ...
    >
      ...
      {/* RE-ENGINEERED EMAIL MODAL (SLIDE UP BOTTOM SHEET) */}
      ...
      {/* RE-ENGINEERED NOTIFICATION MODAL (SLIDE UP BOTTOM SHEET) */}
...
const styles = StyleSheet.create({
  ...
  /* NEW PREMIUM MODAL UI STYLING STACK - CONVERTED TO BOTTOM SHEET */
  modalOverlay: {
    flex: 1,
    backgroundColor: "rgba(10, 10, 12, 0.82)",
  ...
  modalBackdropDismiss: {
    ...StyleSheet.absoluteFillObject, // Tapping background space closes modal
  },
  modalCard: {
    width: "100%",
    borderWidth: 1.5,
    borderTopLeftRadius: scale(18), // Only round the top edges for a clean bottom sheet aesthetic
    borderTopRightRadius: scale(18),
    borderBottomLeftRadius: 0,
    borderBottomRightRadius: 0,
    paddingHorizontal: scale(16),
    paddingTop: verticalScale(10),
    paddingBottom: verticalScale(34), // Ample bottom safe room for layout paddings
    shadowColor: "#000",
    shadowOffset: { width: 0, height: -10 },
    shadowOpacity: 0.4,
    shadowRadius: 16,
