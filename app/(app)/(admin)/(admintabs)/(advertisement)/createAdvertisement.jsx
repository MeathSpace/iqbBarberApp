...
//     params.currentUrl ? { uri: params.currentUrl, name: "Current Image", type: "image/jpeg" } : null
//   );
...
//       Alert.alert("Permission Required", "You need to allow access to your photos to upload advertisements.");
//       return;
//     }
...
//       if (selectedAsset.fileSize && selectedAsset.fileSize > MAX_FILE_SIZE_BYTES) {
...
//       const fileName = uriParts[uriParts.length - 1] || `ad_image_${Date.now()}.png`;
...
//     }
//     if (!adLink.trim()) {
//       Alert.alert("Validation Failed", "Please provide an advertisement redirect link.");
//       return;
//     }
//     if (!imageFile || (!isEditMode && imageFile.name === "Current Image")) {
//       Alert.alert("Validation Failed", "Please upload a promotional 16:9 graphic image.");
//       return;
//     }
...
//         },
//       ];
//       formData.append("advertisementLink", JSON.stringify(advertisementLinkArray));

//       // Append binary object parameter if a brand new file was chosen locally
//       if (imageFile.uri.startsWith("file://") || imageFile.uri.startsWith("content://")) {
...
//         response = await api.post("/advertisement/editAdvertisements", formData, {
//           headers: { "Content-Type": "multipart/form-data" },
//         });
//       } else {
//         response = await api.post("/advertisement/addAdvertisements", formData, {
//           headers: { "Content-Type": "multipart/form-data" },
//         });
//       }

//       Alert.alert("Success", response?.data?.message || "Advertisement handled successfully", [
//         { text: "OK", onPress: () => router.back() },
//       ]);
//     } catch (error) {
//       Alert.alert(
//         "Upload Failure",
//         error?.response?.data?.message || "Something went wrong while synchronizing content items."
//       );
//     } finally {
...
//         subTitle={isEditMode ? "Modify custom banner elements" : "Upload promotional content"}
//         showBack={true}
//       />
...
//               styles.finishButton,
//               {
//                 backgroundColor: submitLoading ? darkTheme.colors.border : darkTheme.colors.accent,
