...
// // Assuming you have your axios/fetch instance configured similarly to Web
...
//   // Hardcoded salonId mimicking the web selector setup
//   const salonId = authenticatedUser?.salonId;

//   // API State structured exactly as preferred
...
//   // 2. Handle Reordering API synchronization sync via useEffect + AbortController
//   useFocusEffect(
//     useCallback(() => {
...
//   // 3. Delete Handler matching Web implementation logic
...
//               // Instantly filter deleted item from local state list
//               setAdvState((prev) => ({
//                 ...prev,
...
//               Using unique _id matching backend structural shape
//             </div> */}
...
//             {/* Actions Block: Conditional action rendering logic matching web version */}
//             {item.type !== "default" ? (
...
//                   onPress={() => {
//                     console.log(item)
//                     // Navigate passing targeted items down route params context
//                     router.push({
...
//                         currentUrl: item.url || "",
//                         publicId: String(item.public_id || ""), // Coerce securely to string context
//                       },
//                     });
//                   }}
//                 >
...
import { GestureHandlerRootView } from "react-native-gesture-handler";
import Shimmer from "react-native-modern-shimmer"; // Integrated Shimmer
import { SafeAreaView } from "react-native-safe-area-context";
import { scale, verticalScale } from "react-native-size-matters";
...
const AdvertisementsScreen = () => {
  ...
  // Simple skeleton loader using your styling configurations
  const ShimmerLoader = () => (
    <View style={styles.shimmerContainer}>
      ...
      {[1, 2].map((key) => (
        <View key={key} style={[styles.adCard, { marginBottom: verticalScale(16), backgroundColor: darkTheme.colors.card, borderColor: darkTheme.colors.border }]}>
          <Shimmer
