...
export const ReportIcon = ({ size = moderateScale(24), color = 'black', style }) => (
    <Ionicons name="document-text-outline" size={size} color={color} style={style} />
);

export const HelpSupportIcon = ({ size = moderateScale(24), color = 'black', style }) => (
    <Feather name="life-buoy" size={size} color={color} style={style} />
);
